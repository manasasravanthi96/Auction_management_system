        ...
        <h1 class="ty-product-block-title"><%=prdTitle %></h1>
		 <div class="brand">
            ...
            <div id="auction_firework">
                <div class="clear2" id="auction_detail_update_232134234">
                    <div class="auction_details_top">
                        ...
                        <div class="auction_details_current_price" id="auction_bg_color_274911_detail1"><span class="price-num">$</span><span class="price-num"><%=minBid %></span></div>
                        <div class ="clear-both"></div>
                    </div>
                    <p class="auction_time_left" id="auction_time_color_274911_detail1"style="padding-left: 103px;">
                        <%=date %>
                    </p>
                </div>
<div id ="bidUpdateDiv">
...
<table><tr><td width="100px">		<label for="bid" class="cm-required ty-control-group__title cm-bid" style="display:none;">Bid Amount</label>
                   <input type="text" name="bid" id="bid" class="input-text auction_bid cm-required cm-numeric" PlaceHolder="<%=minBid %>"  style="font-size:30px;height:45px;mrg" >                    
          </td><td valign="top">  
          <%		
          			int isSeller = 0;
                    if(!UserID.equals("0"))
                   ...
                   <%
              	String query2 = "SELECT bid.bid_id as bidId, bid.bid_amount as bidAmount,bid.dateTime as bidTime,user1.email as bidderEmail,user1.first_name as firstName FROM auctionms_user_mst AS user1, auctionms_bid_mst AS bid WHERE user1.user_id = bid.user_id AND bid.product_id ='"+prdId+"' ORDER BY bid.bid_amount DESC";
        		rs=null;
              ...
              %>
                   ...
                   <div id="sell" style="margin-top:50px;">
                   <form method="get" action="<%=request.getContextPath()%>/Sell">
                    <input type="hidden" name="prdId" value="<%=prdId%>">
                    <input type="hidden" name="bidId" value="<%=bidId%>">
                    <span class="button-submit-action button-wrap-left" style="margin-left: 30px;"><span class="button-submit-action button-wrap-right"><input type="submit" id= "sellsub" value="Sell to <%=highestBidder %>" style="padding:0px 30px; font-size: 34px;font-family: monospace;"></span></span>
                    </form>
                    </div>
                    <% }} %>
                </p> 
            ...
            <div style="margin-top:110px; display:inline-block;margin-left: 147px;" class="clear2" id="auction_detail_update_27491_footer2">
